...
**Goal:** `brew install danmestas/tap/darken` puts a working `darken` binary on a fresh Mac. Same binary works via `go install github.com/danmestas/darkish-factory/cmd/darken@latest` and direct download from GitHub Releases. First release is `v0.1.0`.
...
release:
  ...
  header: |
    See [docs/RELEASING.md](https://github.com/danmestas/darkish-factory/blob/main/docs/RELEASING.md) for upgrade notes.
...
brews:
  - name: darken
    ...
    homepage: "https://github.com/danmestas/darkish-factory"
