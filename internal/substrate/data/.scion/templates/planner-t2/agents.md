# Planner T2 — Worker Protocol

You receive an intent + (optional) research brief from the orchestrator.
...
3. Hand off to the orchestrator for tdd-implementer dispatch.
